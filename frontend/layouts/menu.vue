<template>
  <div class="header-wrapper header-light affix-top">
      <div class="header">
        <div class="container">
          <div class="header-inner">
            ...
            <div class="header-logo">
              <a href="index.html">
                <img v-bind:src="require('../assets/img/layer105.png')" alt="Home">
              </a>
            </div>
    ...
    export default {
        ...
        data () {
          return {
            menu: [
              {
                name: "Recepciones", childs: [
                  {name: "Quintas", link:"#"},
                  {name: "Hoteles", link:"#"},
                  {name: "Salones de fiestas", link:"#"},
                  {name: "Estancias", link:"#"},
